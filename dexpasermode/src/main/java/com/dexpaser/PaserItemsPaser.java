...
public class PaserItemsPaser {
    ...
    public static void paserClassId(int class_defs_size, int classdef[]) {
        ...
        for (int i = 0; i < class_defs_size; i++) {
            ...
            int class_idx = classdef[0];// PaserUtil.byte2int(PaserHaeder.getHeaderInfoByoff(4));
            int ACCESS_FLAGS = classdef[1];//PaserUtil.byte2int(PaserHaeder.getHeaderInfoByoff(4));
            int superclass_idx = classdef[2];//PaserUtil.byte2int(PaserHaeder.getHeaderInfoByoff(4));
            int interfaces_off = classdef[3];// PaserUtil.byte2int(PaserHaeder.getHeaderInfoByoff(4));
            int source_file_idx = classdef[4];// PaserUtil.byte2int(PaserHaeder.getHeaderInfoByoff(4));
            int annotations_off = classdef[5];// PaserUtil.byte2int(PaserHaeder.getHeaderInfoByoff(4));
            int class_data_off = classdef[6];// PaserUtil.byte2int(PaserHaeder.getHeaderInfoByoff(4));
            int values_off = classdef[7];// PaserUtil.byte2int(PaserHaeder.getHeaderInfoByoff(4));
